...
-- Masukkan Sample Submisi Pelajar untuk Paparan Statistik (Hanya jika belum wujud)
INSERT IGNORE INTO `responses` (`email`, `nama`, `tahun`, `kelas`, `luahan_rasa`, `riasec_pilihan`, `komen_status`, `submitted_at`) VALUES
